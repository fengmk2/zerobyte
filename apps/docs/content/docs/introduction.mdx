...
<Callout type="warn">
	Zerobyte is still in version 0.x.x and is subject to major changes between versions. Core features are under active
	development
</Callout>
...
<Callout type="info">
	All backups are encrypted using Restic's encryption. Your encryption password is securely stored and never leaves your
	server.
</Callout>
