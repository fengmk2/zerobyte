...
<Callout type="info">
	In Zerobyte, `--pack-size` in custom Restic parameters affects only the backup schedule where you set it. It does not
	rewrite existing repository data and it does not automatically apply to every other schedule.
</Callout>
